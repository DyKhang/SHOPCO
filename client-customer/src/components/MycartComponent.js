...
class Mycart extends Component {
  ...
  render() {
      ...
      return (
        <tr key={item.product._id} className="datatable">
          ...
          <td className="cart-detail">
            ...
            <div className="cart-product-cates">
              Type: {item.product.category.name}
            </div>
            <div className="cart-product-cates">Quantity: {item.quantity}</div>
            <div className="cart-product-cates">
    ...
    return (
      <div className="align-center item-container">
        <h2 className="text-center item-list">YOUR CART</h2>
        <div className="table">
          ...
          <table className="table-total">
            <tbody className="total-detail">
              <tr>
                <div className="cart-total-name">Order Summary</div>
                <div className="cart-subtotal">
                  Subtotal <td> ${CartUtil.getTotal(this.context.mycart)}</td>
                </div>
                <div className="cart-discount">
                  Discount (20%){" "}
                  <td>
                    -${(CartUtil.getTotal(this.context.mycart) * 20) / 100}
                  </td>
                </div>
                <div className="cart-fee">
                  Delivery Fee <td>$15</td>
                </div>
                <div className="cart-line"></div>
                <div className="cart-total">
                  Total{" "}
                  <td>
                    ${(CartUtil.getTotal(this.context.mycart) * 80) / 100 + 15}
                  </td>
                </div>
