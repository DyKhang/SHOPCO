...
class Product extends Component {
  ...
  render() {
    const prods = this.state.products.map((item) => {
      return (
        <div key={item._id} className="inline inline-mobile">
          <figure>
          ...
          <div class="rates__stars rates__stars_sub">
            <svg
              class="rates__star"
    ...
    return (
      <div className="text-center product-list-container">
        <h2 className="text-center text-header">Casual</h2>
        <label for="filter-mobile-check" class="filter-button-mobile">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="14"
        ...
        <input
          hidden
          type="checkbox"
          class="filter-mobile-check"
          id="filter-mobile-check"
        ></input>
        <label for="filter-mobile-check" class="filter-overlay"></label>
        <div class="container">
          <div class="filters">
            ...
            <div class="filter-group">
              <input
                ...
                id="category1"
              />
              <label for="category1">T-shirt</label>
              <input
                hidden
                type="checkbox"
                class="filter-checkbox"
                id="category2"
              />
              <label for="category2">Short</label>
              <input
                hidden
                type="checkbox"
                class="filter-checkbox"
              ...
              <input
                ...
                id="category4"
              />
              <label for="category4">Skirt</label>
            </div>
            ...
            <div class="filter-group-sizes">
              ...
              <div class="size-options">
                <input
                  ...
                  hidden
                />
                <label class="size-option-btn" for="size-s">
                  Small
                </label>
                <input
                  class="size-option-check"
                  ...
                  hidden
                />
                <label class="size-option-btn" for="size-m">
                  Medium
                </label>
                <input
                  class="size-option-check"
                  ...
                  hidden
                />
                <label class="size-option-btn" for="size-l">
                  Large
                </label>
              </div>
              <input
                ...
                hidden
              />
              <label class="size-option-btn x-large" for="size-xl">
                X-Large
              </label>
            </div>
